...
public class PlayerMove : MonoBehaviour
{
    ...
    private void Move()
    {
        ...
        //1. cc.isGrounded 로 확인 
        if (cc.isGrounded)  // 플레이어가 땅에 닿아있는 상태인지 확인하여 값 반환 
        {
            jumpCount = 0;
            velocityY = 0f;
        }
        ...
        //CollisionFlags.Above(캡슐의 머리)
        //CollisionFlags.Sides(캡슐의 몸통)
        //CollisionFlags.Below(캡슐의 하단)
